class PatientTypeModule {
  ...
  form() {
    return {
      ...
      is_active: "button[data-cy='is_default']",
    };
  }
  ...
  alert() {
    return {
      create: "Patient Type created",
      update: "Patient Type updated",
      archive: "Patient Type deleted successfully",
    };
  }
...
export default PatientTypeModule;

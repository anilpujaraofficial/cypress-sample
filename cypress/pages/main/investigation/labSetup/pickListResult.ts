class PickListResultXpathAssertion {
  button() {
    return {
  ...
  alert() {
    return {
      create: "PicklistResult created",
      update: "Picklist Updated",
      archive: "PickList Result archived successfully",
    };
  }
...
export default PickListResultXpathAssertion;

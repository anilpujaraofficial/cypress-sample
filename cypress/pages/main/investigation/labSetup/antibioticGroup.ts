class AntibioticGroupXpathAssertion {
  button() {
    return {
  ...
  alert() {
    return {
      create: "AntibioticGroup created",
      update: "AntibioticGroup updated",
      archive: "Antibiotic Group Archived successfully",
    };
  }
...
export default AntibioticGroupXpathAssertion;

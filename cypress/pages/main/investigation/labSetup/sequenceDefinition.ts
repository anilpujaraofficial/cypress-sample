class SequenceDefinitionXpathAssertion {
  button() {
    return {
  ...
  form() {
    return {
      ...
      length: "input[data-cy='length']",
      date_format: "input[id='date_format']",
      active: "button[data-cy='active']",
      prefix: "input[data-cy='prefix']",
      suffix: "input[data-cy='suffix']",
    };
  }
  list() {
    return {
  ...
  alert() {
    return {
      create: "Sequence definition added successfully.",
      archive: "Sequence Definition archived successfully",
    };
  }
...
export default SequenceDefinitionXpathAssertion;
